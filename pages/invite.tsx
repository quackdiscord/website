...
export default function Page() {
    ...
    return (
        <main className={`flex min-h-screen flex-col justify-center items-center px-10`} data-theme="dracula">
            <SEOHead title="Invite Quack to your Discord server" />
            ...
            <div className="bg-base-200 text-zinc-500 rounded-md p-2 mt-4 max-w-md overflow-hidden text-ellipsis whitespace-nowrap">
                <a href={redirectPage} className="link link-hover">
                    {redirectPage}
                </a>
            </div>
