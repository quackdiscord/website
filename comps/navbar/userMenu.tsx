...
import { FaArrowCircleLeft, FaBars, FaQuestionCircle } from "react-icons/fa";
...
export default function UserMenu(props: any) {
    ...
    return (
        <div className="dropdown dropdown-end">
            <label tabIndex={0}>
                <div
                    className="flex flex-row items-center justify-center border-1 border-zinc-600 border p-1 rounded-full 
            ...
            <div className="menu menu-sm dropdown-content mt-3 p-4 shadow bg-base-300 rounded-box w-[20em] z-[99] border border-zinc-800">
                <p className="text-xl flex flex-row font-medium">
                    Hey, <span className="text-xl font-bold text-primary ml-1">{user?.name}</span>
                </p>
